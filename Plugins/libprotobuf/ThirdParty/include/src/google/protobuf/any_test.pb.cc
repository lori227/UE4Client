...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "google/protobuf/any_test.proto", schemas, file_default_instances, TableStruct::offsets,
...
TestAny::TestAny()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_google_2fprotobuf_2fany_5ftest_2eproto::scc_info_TestAny.base);
  SharedCtor();
...
const TestAny& TestAny::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fprotobuf_2fany_5ftest_2eproto::scc_info_TestAny.base);
...
void TestAny::SerializeWithCachedSizes(
  ...
  if (this->has_any_value()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      2, this->_internal_any_value(), output);
  }
  ...
  if (this->has_any_value()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        2, this->_internal_any_value(), deterministic, target);
  }
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::protobuf_unittest::TestAny* Arena::CreateMaybeMessage< ::protobuf_unittest::TestAny >(Arena* arena) {
