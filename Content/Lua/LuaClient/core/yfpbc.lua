...
function M.register_file(filename)
	local proto_dir = FToLuaPaths.ProjectContentDir()
   	local fn = string.format("%sLua/proto/pb/%s", proto_dir, filename)
   	print(fn)
